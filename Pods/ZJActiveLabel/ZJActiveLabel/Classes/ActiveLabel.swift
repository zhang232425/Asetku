...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    open var mentionUnderLineStyle: NSUnderlineStyle = .single {
        didSet { updateTextStorage(parseText: false) }
    }
    ...
    open var hashtagUnderLineStyle: NSUnderlineStyle = .single {
        didSet { updateTextStorage(parseText: false) }
    }
    ...
    open var URLUnderLineStyle: NSUnderlineStyle = .single {
        didSet { updateTextStorage(parseText: false) }
    }
